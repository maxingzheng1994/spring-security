...
import com.mxz.security.core.validate.code.image.ImageCode;
 ...
 *时间： 上午12:44:30
 **/
//OncePerRequestFilter  filter工具 确认过滤器每次只调一次
...
public class ValidateCodeFilter extends OncePerRequestFilter implements InitializingBean{
	...
	/**
	 * 存放所需要校验验证码的url, 什么样的url 需要什么的验证
	 */
